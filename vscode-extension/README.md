...
- **Click for the dashboard:** opens a styled usage card — plan reset windows, credits & spend, context usage, and a per-hour token usage bar chart (last 24h, single-color totals per hour with a Y axis + gridlines). Updated live via push.
